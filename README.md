...
# RH Coffee - Coffee Shop Management System
...
![RH Coffee Shop Preview](https://github.com/Simanto5858/RH_coffee_shop/blob/main/images/hero-section.png)
...
4. Create and Configure the Database:
   ...
   - Create a new MySQL database by clicking the "New" option on the left sidebar. Name it `RH-coffee-shop`.
   - Import the database schema from the provided SQL file (`db/RH-coffee-shop.sql`).
...
6. Update Configuration in `config.php`:
   ...
   - Open the `config.php` file and update the following settings to match your local server credentials:
     ...
     $db_name = "RH-coffee-shop";     // Name of the database you created
     ```
...
| Menu Page                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------- |
| ![Menu Page](https://github.com/Simanto5858/RH_coffee_shop/blob/main/images/menu_page.png) |
